...
public class CommunityClan extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	private void showClanListPage(Player player, String searchClanName, String searchPlayerName, String searchAllianceName, int page)
	{
		...
		if (searchClanName.length() == 0 && searchPlayerName.length() == 0 && searchAllianceName.length() == 0)
		{
			...
			searchBoxes.append("<tr>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList_ $findClanName __\" value=\"Find\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList__ $findMemberName _\" value=\"Find\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList___ $findAllyName\" value=\"Find\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
			searchBoxes.append("</td>");
		}
		else if (searchClanName.length() > 0)
		{
			...
			searchBoxes.append("<tr>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList___\" value=\"Clear\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
	...
	private void showClanDetailsPage(Player player, String searchClanName, String searchPlayerName, String searchAllianceName, int page, int clanId)
	{
		...
		if (clan.canEditNotice(player))
		{
			...
			if (clan.getNotice() != null && clan.getNotice().length() > 0)
				clanNotice.append("<button action=\"bypass _bbsclan_editClanNotice_" + convertBackTags(clan.getNotice()) + "\" value=\"Edit\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\">");
			else
				clanNotice.append("<button action=\"bypass _bbsclan_editClanNotice_\" value=\"Edit\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\">");
			clanNotice.append("</td>");
			clanNotice.append("</tr>");
			clanNotice.append("</table>");
		}

	...
	private String getEventInfo(String html, Player player)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					register = "<button value=\"Unregister\" action=\"bypass _bbseventUnregister\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\">";
				}
				else
				{
					register = "<button value=\"Register\" action=\"bypass _bbseventRegister\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\">";
				}
			}

...
public class CommunityBosses implements ScriptFile, ICommunityBoardHandler
{
	...
	private static String getBossListReplacements(String html, int page, Map<Integer, StatsSet> allBosses, boolean nextPage)
	{
		...
		for (Entry<Integer, StatsSet> entry : allBosses.entrySet())
		{
			...
			builder.append("<td width=240 height=25><center><button value=\"Details\" action=\"bypass _bbsboss_%sort%_").append(page).append("_ %search% _").append(entry.getKey()).append("\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\"></center></td>");
		...
		if (page > 0)
			builder.append("<td width=380 align=right><button value=\"Prev\" action=\"bypass _bbsbosslist_%sort%_").append(page - 1).append("_%search%\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\"></td>");
		else
			builder.append("<td width=380 align=right><br></td>");
		// Next
		if (nextPage)
			builder.append("<td width=380 align=left><button value=\"Next\" action=\"bypass _bbsbosslist_%sort%_").append(page + 1).append("_%search%\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\"></td>");
		else
			builder.append("<td width=380 align=right><br></td>");

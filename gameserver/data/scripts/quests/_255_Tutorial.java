...
public class _255_Tutorial extends Quest implements ScriptFile, OnPlayerEnterListener
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else
		{
			...
			// claw - Gives the character some shots
			else if (event.startsWith("GetShotsD ") && player.getVarInt("shots") < 1 && player.getLevel() > 18)
			{
				StringTokenizer tokenizer = new StringTokenizer(event, " ");
				tokenizer.nextToken();
				final int itemId = Integer.parseInt(tokenizer.nextToken());
				...
				if (itemCount > 1000) {
					AutoBan.Banned(player, 999999, "AutoBan Tutorial Bypass");
	...
	private static boolean checkClassMaster(QuestState st)
	{
		...
		if (canChangeClass(player, jobLevel))
		{
			...
			html.append("<html noscrollbar><head><title>Newbie Tutorial</title></head>");
			html.append("<body>");
			...
			html.append("<font name=hs12 color=3399FF>Tutorial</font>");
			html.append("<img src=\"L2UI.squaregray\" width=285 height=1/>");
			html.append("</td></tr></table>");
			html.append("<br></td></tr><tr>");
			html.append("<td align=center height=150>");
			html.append("<table width=280>");
			html.append("<tr><td align=center><br><font color=LEVEL name=hs12>Welcome</font></td></tr>");
			html.append("</table>");
			html.append("<br1>");
